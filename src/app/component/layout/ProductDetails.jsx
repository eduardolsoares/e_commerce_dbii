...
export default function ProductDetails({product}) {
  ...
  if (!product) {
    return (
      <h1 className="text-center text-2xl p-40">Produto não encontrado.</h1>
    );
  }
        ...
        <div>
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition cursor-pointer"
            >
            ...
            {showSnackbar && (
              <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-black text-white px-6 py-3 rounded-full shadow-lg z-50 transition">
                Você precisa escolher uma cor e um tamanho para adicionar ao
                carrinho
              </div>
            )}
          </div>
